          ...
          <section className="content">
            ...
            <div className="sp-cart-btn-container">
              ...
              <span className="amount-btn">
                <button onClick={decreaseAmount}><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"></path></svg></button>
                <h2>{amount}</h2>
